...
public class WorkshopAnnouncementsAdapter extends RecyclerView.Adapter<WorkshopAnnouncementsAdapter.ViewHolder> {
	...
	public WorkshopAnnouncementsAdapter(Context context, AnnouncementInterface announcementInterface) {
