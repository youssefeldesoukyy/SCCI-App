...
//								intent = new Intent(AuthActivity.this, AdminHomeActivity.class);
								...
								intent = new Intent(AuthActivity.this, MemberHomeActivity.class);
							}
							else if(Session.currentUser.getUserType().equals("Head")){
								intent = new Intent(AuthActivity.this, HeadHomeActivity.class);
							}
							else if(Session.currentUser.getUserType().equals("AC")){
								intent = new Intent(AuthActivity.this, ACHomeActivity.class);
							}
							else if(Session.currentUser.getUserType().equals("Participant")){
								intent = new Intent(AuthActivity.this, ParticipantHomeActivity.class);
							}
							else {
