...
import com.example.scciapp.HR.AnnouncementViewActivity;
...
public class HeadAnnouncementAdapter  extends RecyclerView.Adapter<HeadAnnouncementAdapter.myviewholder> {
	Context context;
	ArrayList<Map<String, Object>> items;
	
	public HeadAnnouncementAdapter(Context context, ArrayList<Map<String,Object>> items) {
	...
	@NonNull
	@Override
	public HeadAnnouncementAdapter.myviewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
		return new HeadAnnouncementAdapter.myviewholder(LayoutInflater.from(context).inflate(R.layout.announcement_item_layout, parent, false));
	}
	...
	public void onBindViewHolder(@NonNull myviewholder holder, int position) {
		...
		holder.parent.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				Intent intent = new Intent(context, HeadAnnouncementViewActivity.class);
